export const metadata = {
  title: 'Artister',
  description: 'Utforska alla artister som är signade till Music For Pennies. Se bilder, namn och datum för varje artist.',
  openGraph: {
...
const jsonLd = {
  ...
  description: 'Music For Pennies representerar ett brett spektrum av artister och musiker i Sverige.',
  url: 'https://musicforpennies.se/arrangemang',
  publisher: {
    '@type': 'Organization',
...
export default function ArrangemangLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <script
